...
<!-- generatedFrom: CUR-§1,CUR-§3,CUR-§5,CUR-§9 + USER_STORIES status + latest amendment. Generated by tools/codex.ps1 digest on 2026-06-07. Do not hand-edit. -->

# Cursory (CUR) - Bible digest

Status index (USER_STORIES.md): ✅ 25 | 🟡 7 | ⬜ 7 | 🗑 1
